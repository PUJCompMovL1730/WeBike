...
public class MapPlannedRoute extends AppCompatActivity implements OnMapReadyCallback, PlaceSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MapPlannedRoute.this, "Faltan datos", Toast.LENGTH_LONG).show();
                }
                else
                {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MapPlannedRoute.this, HomeActivity.class));
            }
        });
